...
import imoveis.aluguel.utils.DocumentFormatter;
    ...
    properties.forEach(
        ...
        property -> {
          ...
          var receipt = Receipt.builder()
              ...
              .tenantDocument(DocumentFormatter.formatCpfCnpj(tenant.getCpfCnpj()))
              ...
              .landlordCpf(DocumentFormatter.formatCpfCnpj(landlord.getCpfCnpj()))
