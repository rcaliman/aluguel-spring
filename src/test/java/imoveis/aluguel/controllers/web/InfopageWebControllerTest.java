...
class InfoPageWebControllerTest {
    ...
    void setUp() {
        ...
        propertyDto = new PropertyDtoResponse(1L, PropertyTypeEnum.APARTAMENTO, PropertyUseTypeEnum.RESIDENCIAL, "Rua dos Testes, 123", null, null, null, "123 A", null, null, null, null, null);
