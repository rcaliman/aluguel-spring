...
class LandlordMapperTest {
    ...
    void updateEntity_ShouldUpdateFieldsButKeepIdAndContacts() {
        ...
        source.setDateOfBirth(LocalDate.of(1980, 5, 15));
        ...
        assertEquals(LocalDate.of(1980, 5, 15), target.getDateOfBirth());
        ...
        assertEquals(true, target.getMain());
    ...
    void updateEntity_ShouldUpdateAllFieldsExceptIdAndContacts() {
        ...
        source.setDateOfBirth(LocalDate.of(1990, 3, 20));
        ...
        assertEquals(LocalDate.of(1990, 3, 20), target.getDateOfBirth());
        ...
        assertEquals("Brasileira", target.getNationality());
        assertEquals(false, target.getMain());
    }
}
